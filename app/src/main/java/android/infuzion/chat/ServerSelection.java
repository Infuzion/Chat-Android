 ...
 */
public class ServerSelection extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    private void addEmailsToAutoComplete(List<String> emailAddressCollection) {
        ...
        ArrayAdapter<String> adapter =
                new ArrayAdapter<>(ServerSelection.this,
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            try {
                Client client = new Client(mIp, mPort, mUsername);
            } catch (IOException e) {
                e.printStackTrace();
                return false;
            }
